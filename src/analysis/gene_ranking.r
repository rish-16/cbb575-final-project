...
path <- paste(urld, "acc=GSE119834", "file=GSE119834_raw_counts_GRCh38.p13_NCBI.tsv.gz", sep="&");
...
# sample selection
gsms <- paste0("000000000000000000000000000000000000000000000XXXXX",
        "XXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXXX11111111")
...
plotDispEsts(ds, main="GSE119834 Dispersion Estimates")

# create histogram plot of p-values
hist(r$padj, breaks=seq(0, 1, length = 21), col = "grey", border = "white", 
         xlab = "", ylab = "", main = "GSE119834 Frequencies of padj-values")
...
par(mar=c(7,4,2,1))
boxplot(dat[,ord], boxwex=0.6, notch=T, main="GSE119834", ylab="lg(norm.counts)", outline=F, las=2, col=gs[ord])
